...
function ft_bufferapp_admin_init() {
	...
	foreach($types as $type) {
		add_action('save_' . $type, 'ft_bufferapp_save_post');
		add_action('publish_' . $type, 'ft_bufferapp_publish_post');
		add_action('publish_future_' . $type, 'ft_bufferapp_publish_post');
		add_action('xmlrpc_publish_' . $type, 'ft_bufferapp_xmlrpc_publish_post');
	}
